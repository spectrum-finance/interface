...
export const RewardsDashboard: FC<RewardsDashboardProps> = ({
  ...
  return (
    <Flex col>
          ...
          infoTooltipText={
            <Flex col>
              <Trans>
                ...
                qualify for rewards, liquidity providers must commit to
                providing liquidity for a full epoch. Your rewards will become
                visible on this page after two snapshots have been taken. For
                instance, if you provided liquidity during epoch N, your rewards
                will be displayed starting from epoch N+2.
              </Trans>
              <Typography.Link
      ...
      <Flex.Item marginBottom={4}>
        <TotalRewardsSection
          totalCollectedRewards={rewardsData.totalAvailable}
        />
      </Flex.Item>
      <Flex.Item width="100%">
