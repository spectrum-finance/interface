      ...
      <Page>
        <Display width="800px">
          ...
          <Text p>
            ...
            it doesn’t have a central government body. ErgoDEX Beta UI includes
            only AMM (Swap, Deposit and Redeem) functionality.
          </Text>
          ...
          <Text p>
            ...
            >
              I understand the risks and accept the KYA regarding ErgoDEX Beta
              UI
            </Checkbox>
          </Text>
          <Row>
