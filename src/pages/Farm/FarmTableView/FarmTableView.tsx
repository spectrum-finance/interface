import { Button, Flex, Progress, Typography } from '@ergolabs/ui-kit';
...
import { AprColumn } from '../../Liquidity/common/columns/PoolsOrPositionsColumns/columns/AprColumn/AprColumn';
import { PairColumn } from '../../Liquidity/common/columns/PoolsOrPositionsColumns/columns/PairColumn/PairColumn';
import { TvlOrVolume24Column } from '../../Liquidity/common/columns/PoolsOrPositionsColumns/columns/TvlOrVolume24Column/TvlOrVolume24Column';
...
export const FarmTableView: FC<FarmTableViewProps<any>> = ({
  ...
  >
    ...
    <TableView.Column width={200} title={<Trans>Actions</Trans>}>
      {/*{(ammPool) => <TvlOrVolume24Column usd={poolMapper(ammPool).volume} />}*/}
      {(ammPool) => <Button type="primary">Stake</Button>}
    </TableView.Column>
