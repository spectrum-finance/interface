...
export const ClaimedRewardsCell: FC<NextRewardCellProps> = ({ farm }) => {
    ...
    >
      <Flex col justify="center" stretch>
        ...
        <Typography.Body strong>
          ...
          {rewardState === RewardCellState.REWARD && (
            <Flex align="center">
              <Flex.Item marginRight={1}>
                <AssetIcon
                  asset={farm.collectedRewards?.asset}
                  size="extraSmall"
                />
              </Flex.Item>
              <Typography.Body strong>
