    ...
    <>
      ...
      <Flex flexDirection="col" className="kya-modal">
        <Flex.Item marginBottom={4}>
          <Typography.Body>
            ErgoDEX is a decentralized financial (DeFi) application which means
            it doesn’t have a central government body. ErgoDEX includes AMM
            (Swap, Add liquidity and Remove liquidity) functionality{' '}
        ...
        <Flex.Item>
          <Typography.Body>
            - ErgoDEX operates on a live blockchain, thus trades are final, and
            irreversible once they have status &laquo;executed&raquo;;
          </Typography.Body>
        </Flex.Item>
        <Flex.Item>
          <Typography.Body>
        ...
        <Flex.Item marginBottom={4}>
          <Typography.Body strong>
            ...
            ErgoDEX is without a know your customer (KYC) process and can offer
            NO assistance if a user is hacked or cheated out of passwords,
            currency or private wallet keys.
          </Typography.Body>
        </Flex.Item>
        <Flex.Item marginBottom={4}>
          <Typography.Body strong>
            We recommend that you DO NOT use ErgoDEX to operate large amounts of
            assets!
          </Typography.Body>
        </Flex.Item>
        <Flex.Item>
