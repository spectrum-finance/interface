...
import { Button, Typography } from '../../../ergodex-cdk';
    ...
    <Flex flexDirection="col" className="kya-modal">
      <Flex.Item marginBottom={4}>
        <Typography.Body>
          ...
          doesn’t have a central government body. ErgoDEX includes AMM (Swap,
          Add liquidity and Remove liquidity) functionality{' '}
      ...
      <Flex.Item marginBottom={4}>
        <Typography.Body>
          ...
          smart-contract, all such contracts are wired into the UI. Thus, orders
          are created entirely in your browser (on your machine).
        </Typography.Body>
      </Flex.Item>
      <Flex.Item marginBottom={4}>
        <Typography.Body strong>
