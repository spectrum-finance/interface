...
const questions = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Trans>
          (1) The 2.25 multiplier applies to all delegated ADA that was provided
          as liquidity to the LBSP-labeled liquidity pools. Epoch reward is
          0.006 * 2.25 = 0.0135 SPF per delegated ADA.
        </Trans>
        <Typography.Paragraph />
        <Typography.Paragraph>
          <Trans>
      ...
      <>
        <Typography.Paragraph>
          <Trans>
            ...
            volatility of the pooled assets. If the prices of the tokens in the
            liquidity pool change significantly while providing liquidity, it
            can result in a loss compared to simply holding the tokens.
          </Trans>
        </Typography.Paragraph>
        <Typography.Paragraph>
          <Trans>
            <b>(2) Smart Contract Risks:</b> AMM protocols are powered by smart
            contracts, which are not immune to bugs or vulnerabilities. If
            there&apos;s a flaw in the protocol&apos;s code, it can lead to
            funds being lost or mismanaged.
          </Trans>
        </Typography.Paragraph>
        <Typography.Paragraph>
          <Trans>
            <b>(3) Market Manipulation:</b> Liquidity providers may face the
            risk of market manipulation, especially in smaller and less liquid
            markets. This could result in sudden and sharp price fluctuations
            that impact the value of the provided liquidity.
          </Trans>
        </Typography.Paragraph>
        <Typography.Paragraph>
          <Trans>
  ...
  },
  {
    ...
    content: (
      <>
        <Trans>
          Yes, it is possible, but the reward per epoch will be lower than for
          liquidity provision. The rewarding formula for standard ISPO is
          delegated_ada * 0.006 per epoch. Find the
        </Trans>{' '}
        <Typography.Link
          href="https://cardanoscan.io/pool/27eba5dbeb2b52f5613aa452cf54cab7f9894538d6efb7d271ccc36f"
          target="_blank"
