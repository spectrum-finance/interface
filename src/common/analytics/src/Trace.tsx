...
//   // Highest order context: eg Swap, Pools list or Pools details.
//   page?: string;
...
//         ...parentTrace,
//         ...Object.fromEntries(
//           Object.entries({ page, section, modal, element }).filter(
//             ([_, v]) => v !== undefined,
//           ),
//         ),
//       }),
...
//         // fireAnalyticsEvent(name ?? DEFAULT_EVENT, {
//         //   ...combinedProps,
//         //   ...properties,
//         //   git_commit_hash: analyticsConfig?.commitHash,
//         // });
//         console.log('Trace', 'Log combinedProps', combinedProps);

//         fireAnalyticsEvent(name ?? DEFAULT_EVENT, properties);
//       }
